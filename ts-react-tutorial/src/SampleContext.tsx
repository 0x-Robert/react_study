...
// //디스패치를 위한 타입 (Dispatch를 리액트에서 불러올 수 있음, 액션들의 타입을 
// //Dispatch의 Generics로 설정
...
//             return {
//                 ...state, 
//                 count: action.count // count가 자동완성되며 number 타입인 것을 알 수 있다. 
//             }
//         case "SET_TEXT":
//             return {
//                 ...state,
...
// // SampleStateContext.Provider와 SampleDispatchContext.Provider로 children을 감싸서 반환합니다.
...
//     if (!dispatch) throw new Error("Cannot find SampleProvider"); //유효하지 않을 때 에러 발생 
// }
